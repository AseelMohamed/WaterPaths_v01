...
clc; clear all;
datadir = 'E:/UNB/Projeto/PRGroup/series_sinteticas/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/data/';
...
dlmwrite('E:/UNB/Projeto/PRGroup/series_sinteticas/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/data/Qdaily.txt', Qfinal, ' ');
...
mkdir('E:/UNB/Projeto/PRGroup/series_sinteticas/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/validation/historical');
for i=1:length(files)
   q_nx365 = reshape(Qfinal(:,i),365, [])';
   dlmwrite(['E:/UNB/Projeto/PRGroup/series_sinteticas/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/validation/historical/' files{i}(1:(length(files{i})-14)) '-daily.csv'], q_nx365);
   dlmwrite(['E:/UNB/Projeto/PRGroup/series_sinteticas/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/validation/historical/' files{i}(1:(length(files{i})-14)) '-monthly.csv'], Qfinal_monthly{i}); 
end
