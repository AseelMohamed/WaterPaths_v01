...
Qdaily = load('E:/UNB/Projeto/PRGroup/series_sinteticas/DU_reeval/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/data/Qdaily.txt');
...
mkdir('E:/UNB/Projeto/PRGroup/series_sinteticas/DU_reeval/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/validation/synthetic');
for k=1:length(num_realizations)
    ...
    for i=1:Nsites
        ...
        dlmwrite(['E:/UNB/Projeto/PRGroup/series_sinteticas/DU_reeval/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/validation/synthetic/' sites{i} dimensions{k} '-daily.csv'], saveQ);
    end
    ...
    for i=1:Nsites
        ...
        dlmwrite(['E:/UNB/Projeto/PRGroup/series_sinteticas/DU_reeval/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/validation/synthetic/' sites{i} dimensions{k} '-monthly.csv'], saveMonthlyQ);
    end
    dlmwrite(['E:/UNB/Projeto/PRGroup/series_sinteticas/DU_reeval/streamflow_generator/Kirsch-Nowak_Streamflow_Generator-master/validation/synthetic/Qdaily' dimensions{k} '.csv'], Qd2);
    clear Qd2;
end
