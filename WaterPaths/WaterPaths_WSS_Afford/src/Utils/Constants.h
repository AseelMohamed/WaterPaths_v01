...
namespace Constants {
    ...
    // Experiment 1: 5 objs, reliability=MIN (worst case)
    // Experiment 2: 5 objs, reliability=AVERAGE
    // Experiment 3: 6 objs, reliability=MIN, affordability=MAX (worst case) [DEFAULT]
    // Experiment 4: 6 objs, reliability=AVERAGE, affordability=AVERAGE
...
//#define NUM_DEC_VAR 57;
    ...
    inline int getNumObjectives() {
        // Experiments 1 & 2: 5 objectives (no affordability)
        // Experiments 3 & 4: 6 objectives (with affordability)
        return (EXPERIMENT_MODE == 1 || EXPERIMENT_MODE == 2) ? 5 : 6;
    }
