...
#changed a lot on the commands below
    command_run_rdm = "./triangleSimulation /scratch/spec1058/WaterPaths_jan22 -T {} -t 2080 -r {} -d {} -C -1 -O rof_tables_no112/ -e 0 \
        -U TestFiles_no112/utilities_rdm_reeval.csv \
        -W TestFiles_no112/water_sources_rdm_reeval.csv \
        -P TestFiles_no112/policies_rdm_reeval.csv \
